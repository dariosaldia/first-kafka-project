package dsg.learning.kafkafirstproject;
...
@RestController
public class FirstKafkaController {
    private static final Logger logger = LoggerFactory.getLogger(FirstKafkaController.class);
